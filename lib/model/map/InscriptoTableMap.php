...
class InscriptoTableMap extends TableMap
{
	...
	public function initialize()
	{
		...
		$this->addForeignKey('PERSONA_NRO_DOC', 'PersonaNroDoc', 'INTEGER', 'ranking', 'PELOTARI_NRO_DOC', true, 10, null);
	...
	{
		$this->addRelation('Ranking', 'Ranking', RelationMap::MANY_TO_ONE, array('persona_nro_doc' => 'pelotari_nro_doc', ), null, null);
