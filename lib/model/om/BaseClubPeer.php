...
abstract class BaseClubPeer {
	...
	/** the column name for the NOMBRE_CLUB field */
	const NOMBRE_CLUB = 'club.NOMBRE_CLUB';
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'NombreClub', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'nombreClub', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::NOMBRE_CLUB, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NOMBRE_CLUB', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'nombre_club', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'NombreClub' => 1, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'nombreClub' => 1, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NOMBRE_CLUB => 1, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NOMBRE_CLUB' => 1, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'nombre_club' => 1, ),
		BasePeer::TYPE_NUM => array (0, 1, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(ClubPeer::NOMBRE_CLUB);
		} else {
			$criteria->addSelectColumn($alias . '.ID');
			$criteria->addSelectColumn($alias . '.NOMBRE_CLUB');
		}
	}
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		{
		  call_user_func($sf_hook, 'BaseClubPeer', $criteria, $con);
		}
	 ...
	 *
	 * @param      Club $value A Club object.
	...
	static private function getMixerPreSelectHook($method)
	{
	  ...
	  {
	    return sprintf('BaseClubPeer:%s:%1$s', 'Count' == $match[1] ? 'doCount' : $match[0]);
	  }
