...
abstract class BaseSocioPeer {
	...
	const PERSONA_NRO_DOC = 'socio.PERSONA_NRO_DOC';

	/** the column name for the FECHA_ALTA field */
	const FECHA_ALTA = 'socio.FECHA_ALTA';

	/** the column name for the VITALICIO field */
	const VITALICIO = 'socio.VITALICIO';
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('PersonaNroDoc', 'FechaAlta', 'Vitalicio', 'Activo', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('personaNroDoc', 'fechaAlta', 'vitalicio', 'activo', ),
		BasePeer::TYPE_COLNAME => array (self::PERSONA_NRO_DOC, self::FECHA_ALTA, self::VITALICIO, self::ACTIVO, ),
		BasePeer::TYPE_RAW_COLNAME => array ('PERSONA_NRO_DOC', 'FECHA_ALTA', 'VITALICIO', 'ACTIVO', ),
		BasePeer::TYPE_FIELDNAME => array ('persona_nro_doc', 'fecha_alta', 'vitalicio', 'activo', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('PersonaNroDoc' => 0, 'FechaAlta' => 1, 'Vitalicio' => 2, 'Activo' => 3, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('personaNroDoc' => 0, 'fechaAlta' => 1, 'vitalicio' => 2, 'activo' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::PERSONA_NRO_DOC => 0, self::FECHA_ALTA => 1, self::VITALICIO => 2, self::ACTIVO => 3, ),
		BasePeer::TYPE_RAW_COLNAME => array ('PERSONA_NRO_DOC' => 0, 'FECHA_ALTA' => 1, 'VITALICIO' => 2, 'ACTIVO' => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('persona_nro_doc' => 0, 'fecha_alta' => 1, 'vitalicio' => 2, 'activo' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
	...
	{
		if (null === $alias) {
			$criteria->addSelectColumn(SocioPeer::PERSONA_NRO_DOC);
			$criteria->addSelectColumn(SocioPeer::FECHA_ALTA);
			$criteria->addSelectColumn(SocioPeer::VITALICIO);
			...
			$criteria->addSelectColumn($alias . '.VITALICIO');
	...
	public static function addInstanceToPool($obj, $key = null)
	{
		if (Propel::isInstancePoolingEnabled()) {
			if ($key === null) {
				$key = (string) $obj->getPersonaNroDoc();
			} // if key === null
	...
	public static function removeInstanceFromPool($value)
	{
		if (Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof Socio) {
				$key = (string) $value->getPersonaNroDoc();
	...
	public static function doCountJoinPersona(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(SocioPeer::PERSONA_NRO_DOC, PersonaPeer::NRO_DOC, $join_behavior);
	...
	/**
	 * Selects a collection of Socio objects pre-filled with their Persona objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinPersona(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Socio) to $obj2 (Persona)
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Socio) to the collection in $obj2 (Persona)
				$obj1->setPersona($obj2);
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(SocioPeer::PERSONA_NRO_DOC);
			$value = $criteria->remove(SocioPeer::PERSONA_NRO_DOC);
			if ($value) {
				$selectCriteria->add(SocioPeer::PERSONA_NRO_DOC, $value, $comparison);
			} else {
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		$criteria->add(SocioPeer::PERSONA_NRO_DOC, $pk);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(SocioPeer::DATABASE_NAME);
			$criteria->add(SocioPeer::PERSONA_NRO_DOC, $pks, Criteria::IN);
