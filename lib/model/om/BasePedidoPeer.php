...
abstract class BasePedidoPeer {
	...
	const PROVEEDOR_ID = 'pedido.PROVEEDOR_ID';
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		{
		  call_user_func($sf_hook, 'BasePedidoPeer', $criteria, $con);
		}
	...
	public static function doCountJoinProveedor(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(PedidoPeer::PROVEEDOR_ID, ProveedorPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Pedido objects pre-filled with their Proveedor objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinProveedor(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Pedido) to $obj2 (Proveedor)
				$obj2->addPedido($obj1);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Pedido) to the collection in $obj2 (Proveedor)
				$obj2->addPedido($obj1);
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$value = $criteria->remove(PedidoPeer::ID);
			if ($value) {
				$selectCriteria->add(PedidoPeer::ID, $value, $comparison);
			} else {
	...
	static private function getMixerPreSelectHook($method)
	{
	  ...
	  {
	    return sprintf('BasePedidoPeer:%s:%1$s', 'Count' == $match[1] ? 'doCount' : $match[0]);
	  }
