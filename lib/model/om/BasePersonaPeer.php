...
abstract class BasePersonaPeer {
	...
	const LOCALIDAD_ID = 'persona.LOCALIDAD_ID';
	...
	public static function doCountJoinLocalidad(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(PersonaPeer::LOCALIDAD_ID, LocalidadPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Persona objects pre-filled with their Localidad objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinLocalidad(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Persona) to $obj2 (Localidad)
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Persona) to the collection in $obj2 (Localidad)
				$obj2->addPersona($obj1);
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(PersonaPeer::NRO_DOC);
			$value = $criteria->remove(PersonaPeer::NRO_DOC);
			if ($value) {
				$selectCriteria->add(PersonaPeer::NRO_DOC, $value, $comparison);
			} else {
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		$criteria->add(PersonaPeer::NRO_DOC, $pk);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(PersonaPeer::DATABASE_NAME);
			$criteria->add(PersonaPeer::NRO_DOC, $pks, Criteria::IN);
