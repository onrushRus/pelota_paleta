...
abstract class BaseStockPeer {
	...
	/** the column name for the CANTIDAD_ACTUAL field */
	const CANTIDAD_ACTUAL = 'stock.CANTIDAD_ACTUAL';
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		{
		  call_user_func($sf_hook, 'BaseStockPeer', $criteria, $con);
		}
	...
	public static function doCountJoinProducto(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(StockPeer::PRODUCTO_ID, ProductoPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Stock objects pre-filled with their Producto objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	static private function getMixerPreSelectHook($method)
	{
	  ...
	  {
	    return sprintf('BaseStockPeer:%s:%1$s', 'Count' == $match[1] ? 'doCount' : $match[0]);
	  }
