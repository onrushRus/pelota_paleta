...
abstract class BaseTelefonoPeer {
	...
	const PERSONA_NRO_DOC = 'telefono.PERSONA_NRO_DOC';

	/** the column name for the TELEFONO_NRO field */
	const TELEFONO_NRO = 'telefono.TELEFONO_NRO';
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('PersonaNroDoc', 'TelefonoNro', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('personaNroDoc', 'telefonoNro', ),
		BasePeer::TYPE_COLNAME => array (self::PERSONA_NRO_DOC, self::TELEFONO_NRO, ),
		BasePeer::TYPE_RAW_COLNAME => array ('PERSONA_NRO_DOC', 'TELEFONO_NRO', ),
		BasePeer::TYPE_FIELDNAME => array ('persona_nro_doc', 'telefono_nro', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('PersonaNroDoc' => 0, 'TelefonoNro' => 1, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('personaNroDoc' => 0, 'telefonoNro' => 1, ),
		BasePeer::TYPE_COLNAME => array (self::PERSONA_NRO_DOC => 0, self::TELEFONO_NRO => 1, ),
		BasePeer::TYPE_RAW_COLNAME => array ('PERSONA_NRO_DOC' => 0, 'TELEFONO_NRO' => 1, ),
		BasePeer::TYPE_FIELDNAME => array ('persona_nro_doc' => 0, 'telefono_nro' => 1, ),
		BasePeer::TYPE_NUM => array (0, 1, )
	);
	...
	{
		if (null === $alias) {
			$criteria->addSelectColumn(TelefonoPeer::PERSONA_NRO_DOC);
			$criteria->addSelectColumn(TelefonoPeer::TELEFONO_NRO);
		} else {
			$criteria->addSelectColumn($alias . '.PERSONA_NRO_DOC');
			$criteria->addSelectColumn($alias . '.TELEFONO_NRO');
		}
	}
	...
	public static function addInstanceToPool($obj, $key = null)
	{
		if (Propel::isInstancePoolingEnabled()) {
			if ($key === null) {
				$key = serialize(array((string) $obj->getPersonaNroDoc(), (string) $obj->getTelefonoNro()));
			} // if key === null
	...
	public static function removeInstanceFromPool($value)
	{
		if (Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof Telefono) {
				$key = serialize(array((string) $value->getPersonaNroDoc(), (string) $value->getTelefonoNro()));
	...
	public static function doCountJoinPersona(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(TelefonoPeer::PERSONA_NRO_DOC, PersonaPeer::NRO_DOC, $join_behavior);
	...
	/**
	 * Selects a collection of Telefono objects pre-filled with their Persona objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinPersona(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Telefono) to $obj2 (Persona)
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Telefono) to the collection in $obj2 (Persona)
				$obj2->addTelefono($obj1);
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(TelefonoPeer::PERSONA_NRO_DOC);
			$value = $criteria->remove(TelefonoPeer::PERSONA_NRO_DOC);
			if ($value) {
				$selectCriteria->add(TelefonoPeer::PERSONA_NRO_DOC, $value, $comparison);
			} else {
				$selectCriteria->setPrimaryTableName(TelefonoPeer::TABLE_NAME);
			}

			$comparison = $criteria->getComparison(TelefonoPeer::TELEFONO_NRO);
			$value = $criteria->remove(TelefonoPeer::TELEFONO_NRO);
			if ($value) {
				$selectCriteria->add(TelefonoPeer::TELEFONO_NRO, $value, $comparison);
			} else {
				$selectCriteria->setPrimaryTableName(TelefonoPeer::TABLE_NAME);
			}
	 ...
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			foreach ($values as $value) {
				$criterion = $criteria->getNewCriterion(TelefonoPeer::PERSONA_NRO_DOC, $value[0]);
				$criterion->addAnd($criteria->getNewCriterion(TelefonoPeer::TELEFONO_NRO, $value[1]));
				$criteria->addOr($criterion);
				// we can invalidate the cache for this single PK
				TelefonoPeer::removeInstanceFromPool($value);
			}
		}
	 ...
	 * @param      string $telefono_nro
	 * @param      PropelPDO $con
	 * @return     Telefono
	 */
	public static function retrieveByPK($persona_nro_doc, $telefono_nro, PropelPDO $con = null) {
		$_instancePoolKey = serialize(array((string) $persona_nro_doc, (string) $telefono_nro));
 		if (null !== ($obj = TelefonoPeer::getInstanceFromPool($_instancePoolKey))) {
 			return $obj;
		}
		...
		$criteria->add(TelefonoPeer::PERSONA_NRO_DOC, $persona_nro_doc);
		$criteria->add(TelefonoPeer::TELEFONO_NRO, $telefono_nro);
