...
abstract class BaseProveedorPeer {
	...
	/** the column name for the NOMBRE_PROVEEDOR field */
	const NOMBRE_PROVEEDOR = 'proveedor.NOMBRE_PROVEEDOR';

	/** the column name for the DOM_CALLE field */
	const DOM_CALLE = 'proveedor.DOM_CALLE';

	/** the column name for the DOM_NRO field */
	const DOM_NRO = 'proveedor.DOM_NRO';

	/** the column name for the DOM_PISO field */
	const DOM_PISO = 'proveedor.DOM_PISO';

	/** the column name for the DOM_DPTO field */
	const DOM_DPTO = 'proveedor.DOM_DPTO';
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'NombreProveedor', 'DomCalle', 'DomNro', 'DomPiso', 'DomDpto', 'Telefono', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'nombreProveedor', 'domCalle', 'domNro', 'domPiso', 'domDpto', 'telefono', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::NOMBRE_PROVEEDOR, self::DOM_CALLE, self::DOM_NRO, self::DOM_PISO, self::DOM_DPTO, self::TELEFONO, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NOMBRE_PROVEEDOR', 'DOM_CALLE', 'DOM_NRO', 'DOM_PISO', 'DOM_DPTO', 'TELEFONO', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'nombre_proveedor', 'dom_calle', 'dom_nro', 'dom_piso', 'dom_dpto', 'telefono', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'NombreProveedor' => 1, 'DomCalle' => 2, 'DomNro' => 3, 'DomPiso' => 4, 'DomDpto' => 5, 'Telefono' => 6, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'nombreProveedor' => 1, 'domCalle' => 2, 'domNro' => 3, 'domPiso' => 4, 'domDpto' => 5, 'telefono' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NOMBRE_PROVEEDOR => 1, self::DOM_CALLE => 2, self::DOM_NRO => 3, self::DOM_PISO => 4, self::DOM_DPTO => 5, self::TELEFONO => 6, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NOMBRE_PROVEEDOR' => 1, 'DOM_CALLE' => 2, 'DOM_NRO' => 3, 'DOM_PISO' => 4, 'DOM_DPTO' => 5, 'TELEFONO' => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'nombre_proveedor' => 1, 'dom_calle' => 2, 'dom_nro' => 3, 'dom_piso' => 4, 'dom_dpto' => 5, 'telefono' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(ProveedorPeer::NOMBRE_PROVEEDOR);
			$criteria->addSelectColumn(ProveedorPeer::DOM_CALLE);
			$criteria->addSelectColumn(ProveedorPeer::DOM_NRO);
			$criteria->addSelectColumn(ProveedorPeer::DOM_PISO);
			$criteria->addSelectColumn(ProveedorPeer::DOM_DPTO);
			$criteria->addSelectColumn(ProveedorPeer::TELEFONO);
		} else {
			$criteria->addSelectColumn($alias . '.ID');
			$criteria->addSelectColumn($alias . '.NOMBRE_PROVEEDOR');
			$criteria->addSelectColumn($alias . '.DOM_CALLE');
			$criteria->addSelectColumn($alias . '.DOM_NRO');
			$criteria->addSelectColumn($alias . '.DOM_PISO');
			$criteria->addSelectColumn($alias . '.DOM_DPTO');
