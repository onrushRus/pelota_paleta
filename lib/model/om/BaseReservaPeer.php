...
abstract class BaseReservaPeer {
	...
	/** the column name for the TIPO_RESERVA_ID field */
	const TIPO_RESERVA_ID = 'reserva.TIPO_RESERVA_ID';

	/** the column name for the DIA_COMIENZO_RESERVA field */
	const DIA_COMIENZO_RESERVA = 'reserva.DIA_COMIENZO_RESERVA';

	/** the column name for the HORA_COMIENZO_RESERVA field */
	const HORA_COMIENZO_RESERVA = 'reserva.HORA_COMIENZO_RESERVA';

	/** the column name for the DIA_FIN_RESERVA field */
	const DIA_FIN_RESERVA = 'reserva.DIA_FIN_RESERVA';

	/** the column name for the HORA_FIN_RESERVA field */
	const HORA_FIN_RESERVA = 'reserva.HORA_FIN_RESERVA';
	...
	{
		if (null === $alias) {
			$criteria->addSelectColumn(ReservaPeer::SOCIO_NRO_DOC);
			$criteria->addSelectColumn(ReservaPeer::TIPO_RESERVA_ID);
			$criteria->addSelectColumn(ReservaPeer::DIA_COMIENZO_RESERVA);
			$criteria->addSelectColumn(ReservaPeer::HORA_COMIENZO_RESERVA);
			...
			$criteria->addSelectColumn($alias . '.DIA_COMIENZO_RESERVA');
			$criteria->addSelectColumn($alias . '.HORA_COMIENZO_RESERVA');
	 ...
	 *
	 * @param      Reserva $value A Reserva object.
	...
	public static function addInstanceToPool($obj, $key = null)
	{
		if (Propel::isInstancePoolingEnabled()) {
			if ($key === null) {
				$key = serialize(array((string) $obj->getSocioNroDoc(), (string) $obj->getTipoReservaId(), (string) $obj->getDiaComienzoReserva(), (string) $obj->getHoraComienzoReserva()));
			} // if key === null
	...
	public static function removeInstanceFromPool($value)
	{
		if (Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof Reserva) {
				$key = serialize(array((string) $value->getSocioNroDoc(), (string) $value->getTipoReservaId(), (string) $value->getDiaComienzoReserva(), (string) $value->getHoraComienzoReserva()));
	...
	{
		return array((int) $row[$startcol], (int) $row[$startcol + 1], (string) $row[$startcol + 2], (string) $row[$startcol + 3]);
	}
	...
	public static function doCountJoinSocio(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(ReservaPeer::SOCIO_NRO_DOC, SocioPeer::PERSONA_NRO_DOC, $join_behavior);
	...
	/**
	 * Returns the number of rows matching criteria, joining the related TipoReserva table
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct Whether to select only distinct columns; deprecated: use Criteria->setDistinct() instead.
	 * @param      PropelPDO $con
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinTipoReserva(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		// we're going to modify criteria, so copy it first
		$criteria = clone $criteria;
		...
		$criteria->addJoin(ReservaPeer::TIPO_RESERVA_ID, TipoReservaPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Reserva objects pre-filled with their Socio objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinSocio(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Reserva) to $obj2 (Socio)
	...
	/**
	 * Selects a collection of Reserva objects pre-filled with their TipoReserva objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of Reserva objects.
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinTipoReserva(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$criteria = clone $criteria;
		...
		ReservaPeer::addSelectColumns($criteria);
		$startcol = ReservaPeer::NUM_HYDRATE_COLUMNS;
		TipoReservaPeer::addSelectColumns($criteria);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			$key2 = TipoReservaPeer::getPrimaryKeyHashFromRow($row, $startcol);
			if ($key2 !== null) {
				$obj2 = TipoReservaPeer::getInstanceFromPool($key2);
				if (!$obj2) {

					$cls = TipoReservaPeer::getOMClass();

					$obj2 = new $cls();
					$obj2->hydrate($row, $startcol);
					TipoReservaPeer::addInstanceToPool($obj2, $key2);
				} // if obj2 already loaded

				// Add the $obj1 (Reserva) to $obj2 (TipoReserva)
				$obj2->addReserva($obj1);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		TipoReservaPeer::addSelectColumns($criteria);
		$startcol4 = $startcol3 + TipoReservaPeer::NUM_HYDRATE_COLUMNS;
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Reserva) to the collection in $obj2 (Socio)
				$obj2->addReserva($obj1);
			} // if joined row not null

			// Add objects for joined TipoReserva rows

			$key3 = TipoReservaPeer::getPrimaryKeyHashFromRow($row, $startcol3);
			if ($key3 !== null) {
				$obj3 = TipoReservaPeer::getInstanceFromPool($key3);
				if (!$obj3) {
					...
					TipoReservaPeer::addInstanceToPool($obj3, $key3);
				} // if obj3 loaded

				// Add the $obj1 (Reserva) to the collection in $obj3 (TipoReserva)
				$obj3->addReserva($obj1);
			} // if joined row not null
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinAllExceptTipoReserva(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		// we're going to modify criteria, so copy it first
		$criteria = clone $criteria;
	...
	/**
	 * Selects a collection of Reserva objects pre-filled with all related objects except Socio.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAllExceptSocio(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		TipoReservaPeer::addSelectColumns($criteria);
		$startcol3 = $startcol2 + TipoReservaPeer::NUM_HYDRATE_COLUMNS;
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if (null !== ($obj1 = ReservaPeer::getInstanceFromPool($key1))) {
				...
				$key2 = TipoReservaPeer::getPrimaryKeyHashFromRow($row, $startcol2);
				if ($key2 !== null) {
					$obj2 = TipoReservaPeer::getInstanceFromPool($key2);
					if (!$obj2) {
				...
				// Add the $obj1 (Reserva) to the collection in $obj2 (TipoReserva)
				$obj2->addReserva($obj1);
	...
	/**
	 * Selects a collection of Reserva objects pre-filled with all related objects except TipoReserva.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinAllExceptTipoReserva(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$criteria = clone $criteria;
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(ReservaPeer::SOCIO_NRO_DOC);
			$value = $criteria->remove(ReservaPeer::SOCIO_NRO_DOC);
			if ($value) {
				$selectCriteria->add(ReservaPeer::SOCIO_NRO_DOC, $value, $comparison);
			} else {
				$selectCriteria->setPrimaryTableName(ReservaPeer::TABLE_NAME);
			}

			$comparison = $criteria->getComparison(ReservaPeer::TIPO_RESERVA_ID);
			$value = $criteria->remove(ReservaPeer::TIPO_RESERVA_ID);
			if ($value) {
				$selectCriteria->add(ReservaPeer::TIPO_RESERVA_ID, $value, $comparison);
			} else {
				$selectCriteria->setPrimaryTableName(ReservaPeer::TABLE_NAME);
			}

			$comparison = $criteria->getComparison(ReservaPeer::DIA_COMIENZO_RESERVA);
			$value = $criteria->remove(ReservaPeer::DIA_COMIENZO_RESERVA);
			if ($value) {
				$selectCriteria->add(ReservaPeer::DIA_COMIENZO_RESERVA, $value, $comparison);
			} else {
				$selectCriteria->setPrimaryTableName(ReservaPeer::TABLE_NAME);
			}

			$comparison = $criteria->getComparison(ReservaPeer::HORA_COMIENZO_RESERVA);
			$value = $criteria->remove(ReservaPeer::HORA_COMIENZO_RESERVA);
			if ($value) {
				$selectCriteria->add(ReservaPeer::HORA_COMIENZO_RESERVA, $value, $comparison);
			} else {
				$selectCriteria->setPrimaryTableName(ReservaPeer::TABLE_NAME);
			}
	 ...
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			foreach ($values as $value) {
				$criterion = $criteria->getNewCriterion(ReservaPeer::SOCIO_NRO_DOC, $value[0]);
				$criterion->addAnd($criteria->getNewCriterion(ReservaPeer::TIPO_RESERVA_ID, $value[1]));
				$criterion->addAnd($criteria->getNewCriterion(ReservaPeer::DIA_COMIENZO_RESERVA, $value[2]));
				$criterion->addAnd($criteria->getNewCriterion(ReservaPeer::HORA_COMIENZO_RESERVA, $value[3]));
				$criteria->addOr($criterion);
				// we can invalidate the cache for this single PK
				ReservaPeer::removeInstanceFromPool($value);
			}
		}
	 ...
	 * @param      int $socio_nro_doc
	 * @param      int $tipo_reserva_id
	 * @param      string $dia_comienzo_reserva
	 * @param      string $hora_comienzo_reserva
	 * @param      PropelPDO $con
	 * @return     Reserva
	 */
	public static function retrieveByPK($socio_nro_doc, $tipo_reserva_id, $dia_comienzo_reserva, $hora_comienzo_reserva, PropelPDO $con = null) {
		$_instancePoolKey = serialize(array((string) $socio_nro_doc, (string) $tipo_reserva_id, (string) $dia_comienzo_reserva, (string) $hora_comienzo_reserva));
 		if (null !== ($obj = ReservaPeer::getInstanceFromPool($_instancePoolKey))) {
 			return $obj;
		}
		...
		$criteria->add(ReservaPeer::SOCIO_NRO_DOC, $socio_nro_doc);
		$criteria->add(ReservaPeer::TIPO_RESERVA_ID, $tipo_reserva_id);
		$criteria->add(ReservaPeer::DIA_COMIENZO_RESERVA, $dia_comienzo_reserva);
		$criteria->add(ReservaPeer::HORA_COMIENZO_RESERVA, $hora_comienzo_reserva);
